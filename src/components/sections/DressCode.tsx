  ...
  return (
    ...
    >
      <div className="space-y-10 sm:space-y-12">
          ...
          {palette.map((swatch) => (
            ...
            >
              ...
              <div className="px-1 text-center">
                ...
                <p className="mt-0.5 font-body text-[10px] tracking-wide text-warm-brown">
                  {swatch.en}
                </p>
                <p className="mt-0.5 text-[10px] uppercase tracking-wider text-accent-sage">
                  {swatch.hex}
                </p>
              </div>
            </div>
        ...
        <p className="mx-auto max-w-xl text-center font-body text-[0.95rem] font-normal leading-[1.85] text-warm-brown sm:text-base">
