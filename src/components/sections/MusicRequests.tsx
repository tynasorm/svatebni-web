...
const inputClassName =
  'w-full min-h-12 rounded-xl border border-primary-green/25 bg-off-white px-4 py-3 font-body text-base text-primary-green placeholder:text-primary-green/45 outline-none transition-shadow focus:border-primary-green focus:ring-2 focus:ring-primary-green/20'
...
export function MusicRequests() {
  ...
  return (
    ...
    >
      <p className="mb-8 text-center font-body text-[0.95rem] font-normal leading-[1.85] text-primary-green sm:mb-10 sm:text-base">
              ...
              <div key={fieldId} className="flex gap-2">
                ...
                {number > 1 && number === songCount && (
                  <button
                    ...
                    className="inline-flex min-h-12 shrink-0 items-center justify-center rounded-xl border border-primary-green/25 px-3 font-body text-xs uppercase tracking-wider text-primary-green transition-colors hover:border-primary-green hover:text-primary-green"
